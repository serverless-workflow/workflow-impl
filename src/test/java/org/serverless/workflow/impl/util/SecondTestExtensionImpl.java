...
public class SecondTestExtensionImpl implements Extension {

    public SecondTestExtensionImpl() {

    }

    public SecondTestExtensionImpl(String extensionId,
                                   String testparam1,
                                   String testparam2,
